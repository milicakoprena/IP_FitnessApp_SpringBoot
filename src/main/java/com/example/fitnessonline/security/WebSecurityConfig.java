...
public class WebSecurityConfig {
    ...
    private HttpSecurity createAuthorizationRules(HttpSecurity http) throws Exception {
        ...
        interceptor = interceptor.requestMatchers(HttpMethod.POST, "/login").permitAll().requestMatchers(HttpMethod.POST, "/sign_up").permitAll()
                .requestMatchers(HttpMethod.GET, "/programs").permitAll().requestMatchers(HttpMethod.GET, "/programs/{id}").permitAll()
                .requestMatchers(HttpMethod.GET, "/categories/{id}/programs").permitAll().requestMatchers(HttpMethod.GET, "/programs/{id}/comments").permitAll()
                .requestMatchers(HttpMethod.GET, "/programs/search/{title}").permitAll()
                .requestMatchers(HttpMethod.POST,"/activate").permitAll()
                .requestMatchers(HttpMethod.GET, "/categories/{id}/attributes").permitAll()
                .requestMatchers(HttpMethod.GET, "/attributes/{id}/attributevalues").permitAll()
